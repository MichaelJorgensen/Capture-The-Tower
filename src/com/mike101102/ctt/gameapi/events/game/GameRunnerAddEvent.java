...
public class GameRunnerAddEvent extends GameEvent implements CallableEvent, Cancellable {

    private boolean cancelled = false;
    private static final HandlerList handlers = new HandlerList();

    /**
     * Called when a game is added to the running list of games
     * 
     * @param game to be added
     */
    public GameRunnerAddEvent(Game game) {
        super(game);
    }
